...
class Tensor
{
  public:
    ...
    int n_descriptor_id,randomSampleSize,referencePointId,nOrientations,metric,refPointIBSId,refPointOBJId,pointCloudType,maxDiagId,localResponse,plotDebug,all;
    ...
    std::vector<int> refPointsIdsOb,refPointsIdsIBS;
    ...
    PointCloud::Ptr original_points,toObject,refPointsIBS,refPointsOb;
